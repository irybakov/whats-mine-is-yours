...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", path: "#{github_url}/scripts/nginx.sh", args: [server_ip, public_folder, hostname, "https://raw.githubusercontent.com/joelray/Vaprobash/master"]
